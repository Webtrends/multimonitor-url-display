...
namespace WebBrowserControlDialogs
{
    ...
    public class WindowsInterop
    {
        ...
        public static event GenericDelegate<Boolean, Boolean> SecurityAlertDialogWillBeShown;
        public static event GenericDelegate<String, String, Boolean> ConnectToDialogWillBeShown;
                ...
                WindowsInterop._pWH_CALLWNDPROCRET = SetWindowsHookEx(
                    HookType.WH_CALLWNDPROCRET,
                        WindowsInterop._WH_CALLWNDPROCRET_PROC,
                            IntPtr.Zero,
                            (uint)Convert.ToUInt32(AppDomain.GetCurrentThreadId().ToString()));
